...
- 「是」：根据汤底事实，玩家提问的答案是肯定的。
  例：汤底是"主角是蚊子"，问"主角是动物吗"→是；问"主角会飞吗"→是。
- 「否」：根据汤底事实，玩家提问的答案是否定的。
  例：汤底是"主角是蚊子"，问"主角是人吗"→否；问"主角是植物吗"→否。
- 「无关」：仅当汤底中完全没有涉及该信息，且无法从汤底合理推断时才回答。
  例：汤底是"主角是蚊子"，问"主角喜欢红色吗"→无关（汤底没提颜色偏好）。
  注意：只要汤底中能推断出答案，就不算无关！
- 「恭喜你猜中了！」：玩家直接说出了汤底的核心真相。

关键原则：
1. 优先判断「是」或「否」。只有汤底完全没提、也无法推断的内容才回「无关」。
2. 玩家用"我"自称时，"我"指汤底故事中的主角/当事人。
3. 不得透露汤底内容，不得解释原因，只回答上述四个选项之一。
TXT;
